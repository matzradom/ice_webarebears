...
var xenon = ["Weirdest hooman that had ever lived.", "Xenon? Xenon? Idk him.", "AKA Cheeyin.", "He's actually a nice person. Sometimes.", "idk", "hmm test"];
...
bot.on('message', message => {
        ...
        const modmember = message.author;
        if(message.modmember.roles.has('592295670120185856')) {
